...
| FOCUS WG Chair     | **ADMIN** – All Maintainer permissions, with full administrative control, including managing repository settings, branch protections, and access rights.                       |
